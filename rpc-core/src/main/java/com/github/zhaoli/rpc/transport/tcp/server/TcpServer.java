    ...
    protected ChannelInitializer initPipeline() {
        return new ChannelInitializer<SocketChannel>() {
            protected void initChannel(SocketChannel ch) throws Exception {
                ...
                ch.pipeline()
                        .addLast("IdleStateHandler", new IdleStateHandler(TcpConstant.HEART_BEAT_TIME_OUT_MAX_TIME * TcpConstant.HEART_BEAT_TIME_OUT, 0, 0))
                        // ByteBuf -> Message 
                        ...
                        .addLast("EasyServerHandler", new TcpServerHandler(TcpServer.this));
            }
        };
    }
